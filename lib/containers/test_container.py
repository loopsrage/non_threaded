...
GOLDEN_WARRENTY = """{"status": "active","endDate": "2027-11-01"}"""
...
class Test(unittest.TestCase):
    ...
    def test_read_primitive_value(self):
        container = build_container_tree(start=self.json_data)
        self.assertDictEqual(container.read_primitive_value("root.userProfile.orders.1.items.0.details.warranty"), self.golden_warranty)
        self.assertDictEqual(container.read_primitive_value("root.userProfile.orders.1.shippingAddress"), self.golden_shipping_address)
