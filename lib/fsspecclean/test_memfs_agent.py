...
from lib.fsspecclean.memfs_graph import build_governed_graph
from lib.fsspecclean.memfs_tool_node import fs_react_agent
...
class Test(unittest.TestCase):
    ...
    def test_build_governed_node(self):
        ...
        for rid in request_ids:
            ...
            for i in my_fs.list_images(rid):
                _images["images"].append(i)


            report[rid] = {**_raw, **_clean, **_images}
